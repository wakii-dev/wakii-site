...
*Excerpt from [`native-host.ts` (chrome-extension background script), commit f48e717](https://github.com/hangwin/mcp-chrome/blob/f48e71751e00bc09725c7e173423cff4f2ccd12a/app/chrome-extension/entrypoints/background/native-host.ts)*
...
*Excerpt from [`register-tools.ts` (native server MCP), commit f48e717](https://github.com/hangwin/mcp-chrome/blob/f48e71751e00bc09725c7e173423cff4f2ccd12a/app/native-server/src/mcp/register-tools.ts)*
...
Five releases inside less than a month of June 2025 — exactly the rhythm the README claims for itself: "The project is still in its early stages and is under intensive development" (hangwin/mcp-chrome, [README](https://github.com/hangwin/mcp-chrome#readme)). Then the rhythm stopped: five months later came v1.0.0, and the final commit on the main branch is the merge of PR #272 on 2026-01-06 — roughly eight months as of the 2026-09-08 probe.
