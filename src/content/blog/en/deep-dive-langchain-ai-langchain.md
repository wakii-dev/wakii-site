...
Wakii's gates already stop for humans the way LangChain's middleware does — grab Wakii and start with [getting started](/docs/getting-started/) to see the 9-agent team run while you hold the decisions.
