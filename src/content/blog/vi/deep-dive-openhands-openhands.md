...
Cơ chế thứ hai: automation UI của host không tự giữ dữ liệu nào. Mọi thứ — navigation, endpoint, bản chất trang — đến từ một manifest do package `@openhands/extensions` phát hành; manifest không có hoặc không qua admission, routes trả 404 và navigation không render ([src/manifests/automation-interface.ts](https://github.com/OpenHands/OpenHands/blob/f7fb0c4b21f5ed726edbba8a6309634ef434b004/src/manifests/automation-interface.ts)). Một nhóm tính năng nguyên cụm có thể xuất hiện hoặc biến mất theo manifest — host không phải sửa code.
