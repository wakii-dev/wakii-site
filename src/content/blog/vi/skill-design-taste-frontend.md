...
Mọi skill public trong kit là một file SKILL.md tự cài vào `~/.claude/` trên máy bạn — đọc được nguyên văn, kể cả file hơn 1.200 dòng đã trích trong bài này. Tải Wakii, để agent build xong trang của bạn, rồi đọc nguyên tắc soi của skill trước khi nhấn ship.
