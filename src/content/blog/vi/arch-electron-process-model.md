...
Những câu hỏi cấp sản phẩm — Wakii là gì, khác upstream Orca thế nào, license ra sao — [FAQ](/vi/docs/faq/) có câu trả lời ngắn. Muốn tự soi danh sách bridge đầy đủ, mở thư mục `src/preload/api/` trên repo công khai — mỗi file `*bridge.ts` là một bridge. Còn để thấy ba process hợp tác ra sao trong một luồng thật, bài [vòng đời auto-update](/vi/blog/arch-auto-update-feed/) đi từ GitHub Releases tới nút relaunch ngay trong app.
