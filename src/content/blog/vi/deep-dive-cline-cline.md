...
- **WATCH** — Lõi chung nhiều mặt bán kèm một mặt đóng. Cline mở lõi lẫn CLI, desktop, SDK nhưng giữ JetBrains plugin ngoài mã nguồn; xem "open core, distribution closed" có thành mặc định ngành — nếu có, Wakii nên giữ lõi và mặt phân phối cùng mở (9 agent + 20 skills tại thời điểm viết, công bố cả hai).
